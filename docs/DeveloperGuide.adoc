...
*API* : link:{repoURL}main/blob/master/docs/images/ModuloStorage.png[`ModuloStorage.png`]
...
*API* : link:{repoURL}ain/blob/master/docs/images/ModuloStorage.png[`ModuloStorage.png`]
...
5. Modulo shows the newly created module in the user’s calendar
+
Use case ends.
...
Use case resumes from step 3.
[none]
* 4a. User enters something other than ‘Y’.
[none]
...
[[deadline]] Deadlines
Individual tasks to complete that can be tagged to a specific event. These can be both recurring or just one-off.
