...
Format: done m/cs2103 n/Tutorial (m - module, n - name)
This will bring the closest event to focus e.g. Tutorial 4 happening on Week 6, where the UI will prompt the user: “Which deadline do you wish to complete?”

The following command can then be used (or be used instantly should the user already be viewing the event of interest):
Format: done 1
This will complete the first deadline on the list of deadlines for that event.
